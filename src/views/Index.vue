  ...
  <div class="index-container">
    ...
    <el-card class="record-list-card" title="今日记录">
      <el-table :data="todayRecord" stripe>
        <el-table-column prop="record_type" label="记录类型" width="120" align="center"></el-table-column>
        <el-table-column prop="sub_type" label="详情" width="120" align="center"></el-table-column>
        <el-table-column prop="carbon_output" label="碳排放(kg)" width="120" align="center"></el-table-column>
        <el-table-column prop="carbon_reduce" label="减碳量(kg)" width="120" align="center"></el-table-column>
